...
class _CheckoutScreenState extends State<CheckoutScreen> {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          child: AnimatedContainer(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(m['title'] as String, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700)),
                Text(m['sub'] as String, style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
              ])),
      ...
      _card(child: Padding(
        ...
        child: Column(children: [
          ...
          _summaryRow('Delivery Fee', cart.deliveryFee == 0 ? 'FREE' : '₹${cart.deliveryFee.toStringAsFixed(0)}',
      ...
      Container(
        ...
        child: const Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Please verify all details before placing', style: TextStyle(fontSize: 11, color: AppColors.success)),
          ])),
        ]),
      ),
      const SizedBox(height: 16),
              ...
              ClipRRect(borderRadius: BorderRadius.circular(8),
                child: Image.network(item.food.imageUrl, width: 48, height: 48, fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(width: 48, height: 48,
                      color: AppColors.divider, child: const Icon(Icons.fastfood, size: 20)))),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
  ...
  Widget _summaryRow(String label, String value, {Color? valueColor, bool bold = false, bool large = false}) {
    return Padding(
