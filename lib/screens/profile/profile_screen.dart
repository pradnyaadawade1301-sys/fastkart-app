...
class _NotLoggedIn extends StatelessWidget {
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(children: [
                ...
                _benefit(context, Icons.local_offer_rounded, 'Exclusive Offers',
                    'Get special deals after login', AppColors.primary),
                const SizedBox(height: 16),
                _benefit(context, Icons.receipt_long_rounded, 'Order History',
                    'Track your past orders', AppColors.catMovie),
                const SizedBox(height: 16),
                _benefit(context, Icons.favorite_rounded, 'Save Favourites',
                    'Save your favourite restaurants', AppColors.error),
                const SizedBox(height: 16),
                _benefit(context, Icons.wallet_rounded, 'FastKart Wallet',
  ...
  Widget _benefit(BuildContext context, IconData icon, String title, String sub, Color color) {
    return Container(
...
class _LoggedInProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final u = auth.user;
    final initial = (u?.name.isNotEmpty ?? false) ? u!.name[0].toUpperCase() : 'U';
              ...
              child: Container(
                ...
                child: Row(children: [
                  _stat(context, '💰',
                      ...
                      'Wallet', () => context.push('/wallet')),
                  const SizedBox(width: 12),
                  _stat(context, '⭐', '${u?.points ?? 0}', 'Points',
                      () => context.push('/points')),
                  const SizedBox(width: 12),
                  _stat(context, '🎁', '3', 'Vouchers',
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                _heading('My Account'),
                _menuGroup([
                  _Entry(Icons.edit_outlined, 'Edit Profile', AppColors.primary,
                      () => context.push('/edit-profile')),
                  _Entry(Icons.location_on_outlined, 'Saved Addresses', AppColors.catRide,
                      () => context.push('/addresses')),
                  _Entry(Icons.payment_outlined, 'Payment Methods', AppColors.catFood,
                      () => context.push('/payment-methods')),
                  _Entry(Icons.receipt_long_outlined, 'My Orders', AppColors.catMovie,
                      () => context.go('/orders')),
                  _Entry(Icons.favorite_outline, 'Favourites', AppColors.error,
                      () => context.push('/favorites')),
                ], context),

                _heading('Preferences'),
                _menuGroup([
                  _Entry(Icons.notifications_outlined, 'Notifications', AppColors.catLeisure,
                      () => context.push('/notifications')),
                  // Language option removed
                  _Entry(Icons.dark_mode_outlined, 'Appearance', AppColors.catHotel,
                      () => _showAppearanceSheet(context)),
                ], context),

                _heading('Support'),
                _menuGroup([
                  _Entry(Icons.help_outline_rounded, 'Help & Support', AppColors.catDelivery,
                      () => context.push('/chat?type=support')),
                  _Entry(Icons.info_outline_rounded, 'About FastKart', AppColors.catTravel,
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (_) => AlertDialog(
                        ...
                        content: Text('${u?.name ?? 'Aap'} will be logged out.'),
                        actions: [
                          TextButton(
  ...
  Widget _stat(BuildContext context, String emoji, String val, String label, VoidCallback? onTap) {
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 4),
            Text(val, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800)),
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                ...options.map((a) {
                  final isSelected = themeProvider.themeMode == a['mode'];
                  return ListTile(
                    leading: Container(
                      width: 40, height: 40,
                      decoration: BoxDecoration(
