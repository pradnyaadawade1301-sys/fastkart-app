...
//
// NOTE: flutter_stripe ka Payment Sheet web pe kaam nahi karta.
// Is file mein web-compatible mock payment use kiya hai.
// Android/iOS pe real Stripe chahiye toh backend bhi banana padega.
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> _pay() async {
    ...
    // Simulate payment processing (2 sec)
  ...
  Widget build(BuildContext context) {
    if (_success) {
      return _SuccessView(amount: widget.amount, orderId: widget.orderId);
    }
        ...
        ListView(padding: const EdgeInsets.fromLTRB(16, 16, 16, 120), children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              const SizedBox(height: 4),
              Text('Order #${widget.orderId.length > 6 ? widget.orderId.substring(widget.orderId.length - 6) : widget.orderId}',
          ...
          _Section(title: 'FastKart Wallet', children: [
            _PayTile(icon: '💰', title: 'Wallet Balance',
                subtitle: 'Available: ₹450',
          ...
          // ── UPI ──────────────────────────────────────────────────
          _Section(title: 'UPI Payment', children: [
            ..._upiApps.map((u) => _PayTile(
              icon: u['icon']!, title: u['name']!,
              subtitle: 'Pay via ${u['name']}',
              selected: _selected == 'upi' && _selectedUpi == u['id'],
              onTap: () => setState(() {
                _selected = 'upi'; _selectedUpi = u['id']!;
              }),
            )),
            ...
            Padding(
              ...
              child: TextField(
                ...
                onTap: () => setState(() {
                  _selected = 'upi'; _selectedUpi = 'custom';
                }),
              ),
            ),
          ]),
