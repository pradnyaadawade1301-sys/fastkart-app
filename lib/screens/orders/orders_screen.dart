...
// ─── Order History ────────────────────────────────────────────
class OrdersScreen extends StatefulWidget {           // ✅ was OrderHistoryScreen
...
class _OrderList extends StatelessWidget {
  final List<Order> orders;             // ✅ was OrderModel
  final bool isActive;
...
class _OrderCard extends StatelessWidget {
  final Order order;                    // ✅ was OrderModel
  ...
  Color get _statusColor {
    switch (order.status) {
      ...
      // ✅ removed OrderStatus.rejected (doesn't exist in model)
    }
  }
